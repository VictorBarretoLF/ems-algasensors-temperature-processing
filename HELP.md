...
* The original package name 'com.algaworks.algasensors.temperature-processing' is invalid and this project uses 'com.algaworks.algasensors.temperature_processing' instead.
